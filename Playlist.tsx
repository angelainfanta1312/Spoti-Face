...
export default function createPlaylist(base64: string, face: any) {
  return new Promise(async (resolve, reject) => {
    ...
    function getUserPass() {
      let auth_token =
        "BQB4f_ZVeo-GGupX4GNVd8aVYCqYOTBSNzFNHty7p84thbExJD1nbsQDCIi5NoRIhZoACeSPtUnWBaOkg6zoMr0IogLb87qcIF6nrli-ZPUd6ceyfZaHGG0k871zFhODy_zI82WKu4OWGuf-x2U9T3urFelSwmNZvWIU2bnrut88DASTLk1tegalnRZfvwrrZQZtV9EsX60ROora5xl1_6zdg9Qf6gT8qjU0r-bdl_I7lp4Np_RGiJWwehjCel8lHcmCV1vz3qfz7s1c";
